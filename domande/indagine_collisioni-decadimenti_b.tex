...
\begin{figure}[H]
    \centering
    \incfig{scattering-su-sfera-rigida}
...
.\] 
%2.b.22
\subsection[\hspace{2mm} Esempi di energia minima per far fare l'interazione forte al protone]{Calcolare l'energia minima affinché un protone possa avere una interazione forte "toccando" un nucleo di ${}^{12}C$ o di ${}^{28} Si$.}
...
% 2.b.25
\subsection[\hspace{2mm} Esempi di Q-valore per alcune reazioni]{Cercando i dati nelle apposite tabelle (reperibili sul web) si trovino i Q-valori per le reazioni 
\begin{enumerate}
...
% 2.b.26
\subsection[\hspace{2mm} Invarianza di $d^3p /2E$]{Dimostrare che $\frac{d^3 p  }{2E}$ è un invariante relativistico effettuando esplicitamente la trasformazione di Lorentz (si consideri il boost lungo un asse, per esempio l'asse x)}
...
% 2.b.27
\subsection[\hspace{2mm} Semplificare l'elemento infinitesimo dello spazio dei 4-impulsi con le proprietà della $\delta$]{Dimostrare che 
\[
...
% 2.b.30
\subsection[\hspace{2mm} Trasformazione di una funzione di distribuzione del 3-impulso di una particella]{Come si trasforma una funzione di distribuzione del 3-impulso 
\[
...
% 2.b.31
\subsection[\hspace{2mm} Trasformazione di una funzione di distrib. del 3-impulso e dello spazio per una particella]{Come si trasforma una funzione di distribuzione nello spazio delle fasi 
\[
...
% 2.b.32
\subsection[\hspace{2mm} Probabilità di trovare la particella con probabilita di decadimento indip. dal tempo]{Dimostrare che se la probabilità di decadimento di una particella per unità di tempo non dipende dal tempo, la probabilità di trovare la particella non decaduta al tempo t segue una legge esponenziale.}
...
% 2.b.33
\subsection[\hspace{2mm} Protagonisti della interazione forte]{Dire quali fra le seguenti particelle sono soggette ad interazioni forti: $ p, \overline{p} $, $\pi^{+}, \pi^{-}, \mu^{+}, \mu^{-}, e^{+}$, $e^{-}$, $\alpha,$ Nucleo di Azoto, $\nu, \overline{\nu}$ }
\label{sec:2.b.33}
...
%2.b.35
\subsection[\hspace{2mm} Decadimento del pione carico in muone e neutrino muonico]{Calcolare la funzione di distribuzione in energia ed in angolo nel sistema del laboratorio di un fascio di neutrini o di muoni prodotto nel decadimento di pioni carichi di energia 14 GeV.}
\[
	\ce{\ce{\pi^+} -> \ce{\mu^+} + \ce{\nu_{\mu}}}
.\] 
...
Se un isobaro si trova sulla parabola superiore potrà fare decadimento $\epsilon= \beta^{+}$ se si trovano nella parte sinistra della parabola oppure $\beta^{-}$ se si trovano nella parte destra di quest'ultima, entrambi i decadimenti portano verso un nucleo della parabola inferiore. \\

...
\[
	\Delta Q_1 = \left( m_n + 154 m_u + \Delta_{154, 64} \right) - \left( 155m_u + \Delta_{154, 64 } \right) \approx  \Delta_{154,64}-\Delta_{155,64} 
	\approx - 0.36 \text{ MeV} 
.\]
\[
	\Delta Q_2 = \ldots \approx \Delta_{155,64}-\Delta_{156,64} \approx 0.465 \text{ MeV} 
.\] 
...
\begin{align*}
	d^{4}P \delta\left( P^2-m^2 \right) \theta\left( P_0 \right) =& d^4P \delta\left(\boldsymbol{P}^2 - P_0^2 - m^2 \right) \theta\left( P_0 \right)  = \\
	=& d^4P \theta\left( P_0 \right) \left[ \frac{\delta\left( P_0 - E \right) }{\left| \left[ 2P_0 \right]_{P_0 = E} \right| } + 

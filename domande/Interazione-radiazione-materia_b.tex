...
Nel primo (che è uno scattering elastico) l'elettrone non acquista energia. Nel secondo invece l'energia dell'elettrone è compresa tra gli 0 ed i 10 keV a seconda dell'angolo di scattering.\\
A 100 keV ed a 1 MeV il dominante è il Compton mentre a 10 MeV inizia ad essere importante la produzione di coppie con l'elettrone che viene prodotto con energia di circa 5 MeV.
...
.\] 
Se si incide su 5 mm di piombo con un protone di quella energia si ha che il range è circa 4 mm, per questo il protone non poteva attraversare il ferro.
...
.\] 
Quindi tornando indietro con le formule inverse si ricava facilmente che $\beta_{f}= 0.6$. Analogamente si può procedere per i pioni.

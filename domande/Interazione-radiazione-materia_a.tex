...
\begin{figure}[H]
    ...
    \caption{Screening-Bremsstrahlung}
...
La lunghezza di radiazione $X_0$ è la distanza tipica che una particella percorre in un materiale quando la sua energia è inferiore a quella tipica. Tale distanza infatti subentra nella legge esponenziale (sempre con $E<E_{c}$):
\[
	E = E_0 e^{-x /X_0}
.\] 
...
La legge è applicabile nel caso di Bremstrahlung con particella incidente di energia $E_0$ inferiore della energia $E_{c}$ e descrive l'andamento dell'energia all'interno del materiale in cui tutta l'energia persa va in irraggiamento.
\subsection[]{Descrivere la situazione in cui la legge
	\[
